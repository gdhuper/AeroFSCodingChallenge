...
public class JsonUtility {
    ...
    public  static ArrayList<RepoListItem> getRepos(){
        ArrayList<RepoListItem> list = new ArrayList<>();

        try {

           // JSONArray repoArr = new JSONArray(sampleAPIRespone);

            JSONObject colorObj = new JSONObject(colorCodes);

            JSONArray arr = colorObj.getJSONArray("features");
            ...
            for (int i = 0; i < arr.length(); i++){
                ...
                Log.i("Repos", magnitude + "");

            }
//            Log.i("java: ", colorObj.getString("Java"));
//
//            System.out.println("Log: " + colorObj.getString("Java"));
//            for(int i = 0; i < repoArr.length(); i++){
//
//            JSONObject obj = repoArr.getJSONObject(i);
//
//                String repoName = obj.getString("name");
//
//                Log.i("Repo Name: ", repoName);
//
//
...
//
//               RepoListItem item = new RepoListItem(repoName, lastUpdate, numStars, numForks, numWatcher, "", lang, colorCode);
//
//                list.add(item);
//
//            }
    ...
    {
        ArrayList<RepoListItem> list = getRepos();
